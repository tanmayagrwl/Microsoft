  ...
  return (
    <>
      <div className="flex flex-col items-center w-full justify-center h-[70vh]">
        ...
        <div className="text-3xl md:6xl lg:text-7xl font-serif pt-5">
          Microsoft Account
        </div>
        <div className="flex justify-center text-md sm:text-md pl-8 pr-8 pt-8 text-center md:text-xl lg:text-2xl">
          Your Microsoft account connects all your Microsoft apps and services.
        </div>
        <div className="flex justify-center text-md sm:text-md pl-8 pt-2 pr-8 text-center md:text-xl lg:text-2xl">
