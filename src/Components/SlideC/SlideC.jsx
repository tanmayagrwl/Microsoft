  ...
  return (
    ...
    <div class='flex flex-col-reverse sm:flex-col md:flex-row justify-between pl-4 pr-4 lg:pl-28 lg:pr-48 pt-8 sm:pt-8 md:pt-24'>
        <div class='flex flex-col justify-center lg:pr-64 md:pr-36 pl-4 lg:pl-0 pr-0 '>
            <div class='font-semibold text-2xl md:text-5xl lg:text-6xl mb-8 '>Security your way</div>
            <div class='text-xl'>Choose security and privacy settings that work best for you and rest easy with automatic alerts for unusual or suspicious account activity.</div>
        </div>
        <img src={sc1} alt="" class='rounded-md shadow-lg over:shadow-2xl h-72 md:h-80 w-full sm:w-full md:w-96 mb-8 sm:mb-0 md:mb-0 md:mr-8 lg:mr-0' />
    </div>
    ...
    <div class='flex flex-col-reverse sm:flex-col md:flex-row justify-between pl-4 pr-4 lg:pl-28 lg:pr-48 pt-8 sm:pt-8 md:pt-24'>
        <div class='flex flex-col justify-center lg:pr-64 md:pr-36 pl-4 lg:pl-0 pr-0 '>
            <div class='font-semibold text-2xl md:text-5xl lg:text-6xl mb-8 '>One place to manage it all</div>
            <div class='text-xl'>Manage your account from a single dashboard, including payment information, purchases, subscriptions, and more.</div>
        </div>
        <img src={sc3} alt="" class='rounded-md shadow-lg over:shadow-2xl h-72 md:h-80 w-full sm:w-full md:w-96 mb-8 sm:mb-0 md:mb-0 md:mr-8 lg:mr-0' />
    </div>
